...
const SummaryCard = ({ summary, docType = 'prescription' }) => {
  ...
  <div className="card interactive-panel">
        ...
        {summary.abnormalities && (
          <div className="card interactive-panel" style={{borderLeft:'4px solid #fb923c', background:'linear-gradient(135deg,#fff7ed,#fff)'}}>
  ...
  <div className="glass rounded-lg p-4 interactive-panel" style={{background:'linear-gradient(135deg,#fef2f2,#ffffffdd)'}}>
