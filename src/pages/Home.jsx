...
const Home = () => {
	return (
		<div className="space-y-20">
			{/* Hero */}
			<section className="relative overflow-hidden rounded-2xl gradient-brand text-white px-6 py-20 flex flex-col items-center text-center shadow-md">
				<div className="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_30%_30%,#ffffff55,transparent_60%)]" />
				<div className="relative max-w-3xl mx-auto">
					<div className="inline-flex items-center gap-2 text-xs font-medium bg-white/10 border border-white/20 backdrop-blur px-3 py-1 rounded-full mb-6">
			...
			<section>
				...
				<div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
					{featureItems.map(({ icon: Icon, title, desc }) => (
						<div key={title} className="group bg-white border rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow flex flex-col">
			...
			<section>
				...
				<ol className="grid gap-6 md:grid-cols-3">
					{steps.map(s => (
						<li key={s.number} className="relative bg-white border rounded-xl p-6 shadow-sm flex flex-col">
			...
			<section className="bg-white border rounded-2xl p-8 shadow-sm">
				<div className="grid md:grid-cols-3 gap-8 items-start">
					...
					<div className="space-y-4">
						<div className="gradient-brand text-white rounded-xl p-5 shadow flex flex-col gap-3">
